...
basic:- write(' Enter name: '),nl,read(N),
        ...
        nl, write(' Second Number: '),write(Num2),nl,
    	nl, runagain.

runagain:-nl,write('Another Entry (y/n): '),nl,read(Ans),
    	(Ans == y ->   basic;nl,write('bye')).
...
basic_calc:-nl,write(' Enter num1: '),nl,read(Num1),
            ...
            Avg is Sum/2, %doaverage(Num1,Num2,Avg), %doaverage function called
...
doavg(Num1,Num2,Avg):-Avg is (Num1+Num2)/2.

basic_calc1:-nl,write(' Enter num1: '),nl,read(Num1),
            nl,write(' Enter num2: '),nl,read(Num2),
            doavg(Num1,Num2,Avg),
    		nl,write('Average: '),write(Avg).
...
%________________________________________________________
basic_func:-nl,write(' Enter num1: '),nl,read(Num1),
            nl,write(' Enter num2: '),nl,read(Num2),
            Avg is (Num1 + Num2) - (Num2 * 2),
    		nl,write('Average: '),write(Avg).
...
*/
check_midpoint:-nl,write(' Enter num1: '),nl,read(Num1),
    			(Num1 > 10 ->  write(Num1),write(' is greater than 10');
                Num1 == 10 ->  write(Num1),write(' is equal to 10');
                Num1 < 10 ->  write(Num1),write(' is less than 10')),check_midpoint.
/*
If, Then,Else
X < Y -> write(X);write(Y).
